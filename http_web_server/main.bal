...
final string rootDir = "../resources/basic-app/build";
final int port = 9090;
...
service / on new http:Listener(port) {
    isolated resource function get [string... paths](http:Caller caller, http:Request request) returns error? {
        http:Response res = new;
        string requestedFilePath = checkpanic file:joinPath(rootDir, ...paths);
